    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "No ingresar más de '" + $this.attr("maxlength") + "' caracteres<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Se necesitan al menos '" + $this.attr("minlength") + "' caracteres<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Correo No Válido<!-- data-validation-email-message to override -->";
        ...
        builtInValidators: {
            ...
            required: {
                name: "Required",
                type: "required",
                message: "Campo obligatorio<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
