                                            ...
                                            <div class="card-body">
                                                <div class="divider">
                                                    <div class="divider-text text-uppercase text-muted">
                                                        <small>Ingrese una nueva contraseña</small>
                                                    </div>
                                                </div>
                                                <form method="POST" novalidate>
                                                    <div class="form-group mb-50">
                                                        <div class="controls">
                                                            <label class="text-bold-600" for="usuario">Contraseña</label>
                                                            <input type="password" class="form-control" id="pass" name="pass" placeholder="Contraseña" required autofocus>
                                                            <span class="danger"><?php echo $usuario_err; ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="text-bold-600" for="pass">Repetir contraseña</label>
