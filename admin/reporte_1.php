            ...
            <div class="content-body">
                ...
                <section id="apexchart">
                    <div class="row">
                        ...
                        <?php
                        $script_pie = "";
                        $evaluaciones_progreso_query = mysqli_query($link, "SELECT evaluacion.*, empresa.nombre AS empresa FROM evaluacion, empresa WHERE evaluacion.estado = 'En progreso' AND evaluacion.id_empresa = empresa.id AND evaluacion.id_empresa = $id_empresa");
