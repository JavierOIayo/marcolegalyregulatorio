...
$evaluacion_query = mysqli_query($link, "SELECT evaluacion.*, empresa.nombre AS empresa, ley.nombre AS ley FROM evaluacion, empresa, ley, asignar_gerente WHERE evaluacion.id_empresa = empresa.id AND evaluacion.id_ley = ley.id AND asignar_gerente.id_empresa = empresa.id AND asignar_gerente.id_usuario = $s_id");
$empresas_query = mysqli_query($link, "SELECT empresa.* FROM empresa, asignar_gerente WHERE estado = 1 AND empresa.id = asignar_gerente.id_empresa AND asignar_gerente.id_usuario = $s_id");
                                                        ...
                                                        echo "<tr>
                                                                ...
                                                                <div class='dropdown'>
                                                                    ...
                                                                    <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                                                        <a class='dropdown-item' href='evaluar_articulos.php?evaluacion={$evaluaciones["id"]}'>Ver artículos evaluados</a>    
                                                                    </div>
                                                                </div></td>
                                                            </tr>";
                                                    }
